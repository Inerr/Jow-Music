...
const install = (args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let content = (0, fs_1.readFileSync)((0, path_1.join)(process.cwd(), "hammer.toml"), "utf-8");
    const toml = (0, toml_1.parse)(content);
    toml.dependencies = toml.dependencies || [];
    for (const pkg of packages) {
        if (!toml.dependencies.includes(pkg))
            toml.dependencies.push(pkg);
    }
    content = (0, toml_1.stringify)(toml);
    (0, fs_1.writeFileSync)((0, path_1.join)(process.cwd(), "hammer.toml"), content);
